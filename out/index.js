(() => {
  ...
  // src/Observable.js
  var Observable = class extends Cleanable {
    static {
  ...
  // src/Component.js
  var Component = class extends Observable {
    static {
  ...
  var Control = class extends Component {
    ...
    constructor(design) {
      ...
      this.text = [(0, import_oneof.default)(a), (0, import_oneof.default)(b)].join(" ");
    }
    // get x(){
    //   return 0
    //     + this.container.x
  ...
  var List = class extends Observable {
    ...
    add(...items) {
      for (const item of items) {
        if (!(Container.prototype.isPrototypeOf(item) || Control.prototype.isPrototypeOf(item)))
  ...
  // src/model/List.js
  var List2 = class extends Observable2 {
    static {
      __name(this, "List");
    }
    #list = [];
  ...
  // src/model/Item.js
  var Item = class extends Observable2 {
    static {
      __name(this, "Item");
    }
  };

  // src/model/Archetype.js
  ...
  // src/model/Connectable.js
  var Connectable = class extends Item {
    static {
  ...
  // src/model/Connection.js
  var Connection = class extends Item {
    static {
  ...
  // src/execute/Basic.js
  var import_pick = __toESM(require_pick(), 1);

  // src/execute/Branch.js
  ...
  // src/Workspace.js
  var Workspace = class extends Container {
    static {
